          ...
          {ACHIEVEMENTS.map((achievement, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -5 }}
                className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-cyan-500/50 hover:bg-slate-800 transition-all group shadow-lg hover:shadow-cyan-500/10"
              >
