      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-8 relative border-l-2 border-slate-800 ml-3 pl-8 py-2">
              {EXPERIENCE.map((exp, index) => (
                <motion.div
                    ...
                    className="relative"
                >
                  <span className="absolute -left-[41px] top-0 h-5 w-5 rounded-full border-4 border-slate-900 bg-cyan-500"></span>
                  
                  <div className="bg-slate-900 p-6 rounded-lg border border-slate-800 hover:border-slate-700 transition-all shadow-lg">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {exp.technologies.map(tech => (
                            <span key={tech} className="px-2 py-1 text-xs rounded bg-slate-800 text-cyan-400 border border-slate-700">
                                {tech}
                            </span>
                        ))}
                    </div>
              ...
              >
                  <div className="flex flex-wrap gap-3">
                    {CERTIFICATIONS.map((cert, i) => (
                        <span key={i} className="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-slate-800 text-cyan-400 border border-slate-700">
                            {cert}
                        </span>
                    ))}
                  </div>
